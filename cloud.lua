...
if game:GetService("CoreGui"):FindFirstChild("AzureLibCloudHub") or game:GetService("CoreGui"):FindFirstChild("InsertedObjects") or game:GetService("CoreGui"):FindFirstChild("WeAllKnowCloudHubOnTop") then
	...
	elseif game.PlaceId == 443406476 then
		...
		if game:GetService("RunService"):IsStudio() then
			...
			_G.CustomTheme = {Tab_Color = Color3.fromRGB(25, 25, 25),Tab_Text_Color = Color3.fromRGB(241, 134, 255),Description_Color = Color3.fromRGB(25, 25, 25),Description_Text_Color = Color3.fromRGB(241, 134, 255),Container_Color = Color3.fromRGB(25, 25, 25),Container_Text_Color = Color3.fromRGB(255, 255, 255),Button_Text_Color = Color3.fromRGB(255, 255, 255),Toggle_Box_Color = Color3.fromRGB(255, 92, 92),Toggle_Inner_Color = Color3.fromRGB(105, 255, 107),Toggle_Text_Color = Color3.fromRGB(255, 255, 255),Toggle_Border_Color = Color3.fromRGB(35, 35, 35),Slider_Bar_Color = Color3.fromRGB(25, 25, 25),Slider_Inner_Color = Color3.fromRGB(241, 134, 255),Slider_Text_Color = Color3.fromRGB(255, 255, 255),Slider_Border_Color = Color3.fromRGB(35, 35, 35),Dropdown_Text_Color = Color3.fromRGB(255, 255, 255),Dropdown_Option_BorderSize = 1,Dropdown_Option_BorderColor = Color3.fromRGB(49, 50, 51),Dropdown_Option_Color = Color3.fromRGB(25, 25, 25),Dropdown_Option_Text_Color = Color3.fromRGB(205, 205, 205)}
			local a =
    syn and "Synapse X"
			if a then
				game.StarterGui:SetCore("SendNotification", {
